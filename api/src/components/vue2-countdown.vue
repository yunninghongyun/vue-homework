<template>
  <div v-if="msTime.show" class="countdown">
    <!--<span v-if="tipShow">{{tipText}}:</span>-->
    <!--<span v-if="!tipShow">{{tipTextEnd}}:</span>-->
    <div>
      <span v-if="msTime.day>0">
        <span class="i">{{msTime.day}}</span>
        <span class="word">{{dayTxt}}</span>
      </span>
    </div>
    <span>:</span>
    <div>
      <span class="i">{{msTime.hour}}</span>
      <span class="word">{{hourTxt}}</span>
    </div>
    <span>:</span>
    <div>
      <span class="i">{{msTime.minutes}}</span>
      <span class="word">{{minutesTxt}}</span>
    </div>
    <span>:</span>
    <div>
      <span class="i">{{msTime.seconds}}</span>
      <span class="word">{{secondsTxt}}</span>
    </div>
  </div>
